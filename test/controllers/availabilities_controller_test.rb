...
class AvailabilitiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create availability" do
    assert_difference("Availability.count") do
      post availabilities_url, params: { availability: { course_id: @availability.course_id, day: @availability.day, end_time: @availability.end_time, preferred: @availability.preferred, start_time: @availability.start_time } }
    end
  ...
  test "should update availability" do
    patch availability_url(@availability), params: { availability: { course_id: @availability.course_id, day: @availability.day, end_time: @availability.end_time, preferred: @availability.preferred, start_time: @availability.start_time } }
