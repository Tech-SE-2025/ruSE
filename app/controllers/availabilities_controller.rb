class AvailabilitiesController < ApplicationController
  ...
  def create
    @availability = @course.availabilities.create(availability_params)

    respond_to do |format|
      if @availability.save
        format.html { redirect_to course_url(@course), notice: "Availability was successfully created." }
  ...
  private
    ...
    def availability_params
      params.require(:availability).permit(:day, :start_time, :end_time, :preferred, :course_id)
    end
